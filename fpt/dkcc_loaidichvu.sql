...
CREATE TABLE `loaidichvu` (
  `MaLoaiDV` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `TenLoaiDV` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `loaidichvu` VALUES ('DV01','Dich Vu Tron Goi'),('DV02','Ban Xe'),('DV03','Sua Xe'),('DV04','Bao Tri');
